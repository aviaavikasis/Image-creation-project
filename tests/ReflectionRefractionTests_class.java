...
public class ReflectionRefractionTests {
    ...
    public void twoSpheresOnMirrors() {
        ...
        scene.addGeometries(
                ...
                new Triangle(new Point3D(1500, 1500, 1500), new Point3D(-1500, -1500, 1500), new Point3D(-1500, 1500, 2000),new Color(20, 20, 20), new Material(0, 0, 0, 0, 0.5)));
    ...
    public void trianglesTransparentSphere() {
        ...
        scene.addGeometries( //
                new Triangle(new Point3D(-150, 150, 115), new Point3D(150, 150, 135), new Point3D(75, -75, 150),Color.BLACK, new Material(0.5, 0.5, 60)),
                new Triangle(new Point3D(-150, 150, 115), new Point3D(-70, -70, 140), new Point3D(75, -75, 150),Color.BLACK, new Material(0.5, 0.5, 60)),
