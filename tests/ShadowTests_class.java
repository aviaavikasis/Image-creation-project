...
public class ShadowTests {
    ...
    public void SphereTriangleInitial() {
        ...
        scene.addLights(new SpotLight(new Color(400, 240, 0),new Point3D(-100, 100, -200),1, 1E-5, 1.5E-7, new Vector(1, -1, 3)));

        ImageWriter imageWriter = new ImageWriter("sphereTriangleInitial", 200, 200, 400, 400);
        Render render = new Render(imageWriter, scene);
        scene.setSoftShadow(false);
        //render.SuperSampling(0,0,400,400,1);
    ...
    public void trianglesSphere() {
        ...
        scene.addLights(new SpotLight(new Color(700, 400, 400),new Point3D(40, -40, -115),1, 4E-4, 2E-5, new Vector(-1, 1, 4)));
